...
github   : charli-lover                               
Facebook : charli                   
YouTube  : Tecnical Luqman            
Whatsapp : +923186384968                            
                                                 [THIS TOOL IS FREE]
_____________________________________ """
def Jadu():
	os.system("clear")
	os.system("xdg-open https://www.youtube.com/channel/UCljWdYIg_gDjuHvxaafbQPQ")
	print(logo)
...
def login():
	...
	try:
		...
		head = {"user-agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36"}
